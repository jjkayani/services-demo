...
import com.service.review.controller.ReviewController;
...
public class SpringFoxConfig {
    ...
    public Docket apiDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage(ReviewController.class.getPackage().getName()))
    ...
    private Tag[] tags() {
        return new Tag[]{
                new Tag("ReviewController", "This is the only controller in this service"),
        };
    }
    ...
    private static ApiInfo apiInfo() {
        return new ApiInfo("Review Service", "This is a review service", "1.0",
