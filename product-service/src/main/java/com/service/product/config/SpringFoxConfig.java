...
import com.service.product.payload.error.ErrorResponseModel;
...
public class SpringFoxConfig {
    ...
    private Tag[] tags() {
        return new Tag[]{
                new Tag("ProductController", "This is the only controller in this service"),
        };
    }
    ...
    private static ApiInfo apiInfo() {
        return new ApiInfo("Product Service", "This is a Product service", "1.0",
